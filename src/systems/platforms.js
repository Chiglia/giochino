...
export function createPlatforms(scene, layout, tintColor) {
  // StaticGroup = corpi fisici immobili, ottimizzati per molte collisioni
  const group = scene.physics.add.staticGroup();

  // Usa il layout passato o quello di default se non specificato
